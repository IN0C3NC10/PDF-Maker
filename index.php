        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">
                    <image src="/assets/images/pdf_logo.png" width="40" /> <?= $config['SITE_NAME'] ?>
                </h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
...
?>
    ...
    <body>
        ...
        <div class="page-inner">
            <div class="page-title">
                <h3 class="breadcrumb-header">Ooops!</h3>
            </div>
            <div id="main-wrapper">
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel panel-white">
                            <div class="panel-body">
                                <h3>Tivemos um pequeno problema!</h3>
                                <p>Ao que parece o seu arquivo de configurações não foi criado, <a href="./build_ini_file.php" class="mainHover">Clique Aqui</a> para cria-lo agora.</p>
                            </div>
                        </div>
                    </div>
                </div><!-- Row -->
